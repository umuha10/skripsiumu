              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <label> Intensitas Kepentingan *</label>
                    <select name="intensitas_kepentingan" id="intensitas_kepentingan" class="form-control">
                      <?php for ($i = 1; $i < 10; $i++) : ?>
        ...
        <tbody>
          <?php foreach ($row->result() as $key => $data) { ?>
            <tr>
              ...
              <td><?= $data->kriteria ?></td>
              <td><?= $data->intensitas_kepentingan ?></td>
              <td>
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <div class="col-sm-12">
                              ...
                              <select name="intensitas_kepentingan" id="intensitas_kepentingan" class="form-control">
                                <?php for ($i = 1; $i < 10; $i++) : ?>
                                  <option value="<?= $i ?>" <?= ($data->intensitas_kepentingan == $i) ? 'selected' : '' ?>><?= $i ?></option>
                                <?php endfor; ?>
                              </select>
                            </div>
                          </div>
